      ...
      <div class="w-full py-xl px-lg grid grid-cols-1 md:grid-cols-4 gap-lg max-w-container-max mx-auto">
        ...
        <div class="space-y-md">
          ...
          <ul class="space-y-2 font-body-md">
            <li><a class="text-on-secondary opacity-80 hover:opacity-100 transition-opacity" href="/ourfleet">Affordable Boats</a></li>
            <li><a class="text-on-secondary opacity-80 hover:opacity-100 transition-opacity" href="/ourfleet">Luxury Yachts</a></li>
            <li><a class="text-on-secondary opacity-80 hover:opacity-100 transition-opacity" href="/ourfleet">Party Vessels</a></li>
            <li><a class="text-on-secondary opacity-80 hover:opacity-100 transition-opacity" href="/ourfleet">All Vessels</a></li>
          </ul>
        </div>
        <div class="space-y-md">
